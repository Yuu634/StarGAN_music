...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_configpath', type=str, default="../Moonbeam-MIDI-Foundation-Model/src/llama_recipes/configs/player_classification_config.json", help='path to the discriminator config')
    
    # Training configuration.
    parser.add_argument('--dataset', type=str, default='MidiCaps', choices=['MidiCaps'])
